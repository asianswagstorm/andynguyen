...
const DEFAULT_STATES = {
  defaultConnectFourStates: { ...defaultConnectFourStates },
};
...
const connectFourReducer = (state = DEFAULT_STATES, action) => {
  switch (action.type) {
    case "SET_CONNECT_FOUR_TABLE":
      return {
        ...state,
        defaultConnectFourStates: {
          ...state.defaultConnectFourStates,
          connectFourBoard: action.connectFourBoard,
        },
      };
    case "RESET_CONNECT_FOUR_GAME":
      return {
        ...
        defaultConnectFourStates: {
          ...state.defaultConnectFourStates,
          connectFourBoard: action.connectFourBoard,
          rowIndexByColumn: [...action.rowIndexByColumn],
    ...
    case "UPDATE_COMPUTER_COLUMN":
      return {
        ...
        defaultConnectFourStates: {
          ...state.defaultConnectFourStates,
          computerCurrentColumn: action.computerCurrentColumn,
        },
      };
    case "UPDATE_AVAILABLE_COLUMNS":
      return {
        ...
        defaultConnectFourStates: {
          ...state.defaultConnectFourStates,
          availableCols: action.availableCols,
        },
      };
    default:
